...
class _document_MyDocument extends document_default.a {
  static getInitialProps({
    ...
    const sheet = new external_styled_components_["ServerStyleSheet"](); // Step 2: Retrieve styles from components in the page
  ...
  render() {
    return __jsx("html", null, __jsx(next_document["Head"], null, __jsx("title", null, "Page"), __jsx("meta", {
      name: "viewport",

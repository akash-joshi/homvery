...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_7___default.a {
  static getInitialProps({
    ...
    const sheet = new styled_components__WEBPACK_IMPORTED_MODULE_9__["ServerStyleSheet"](); // Step 2: Retrieve styles from components in the page

    const page = renderPage(App => props => sheet.collectStyles(__jsx(App, props))); // Step 3: Extract the styles as <style> tags
  ...
  render() {
    return __jsx("html", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_7__["Head"], null, __jsx("title", null, "Page"), __jsx("meta", {
      name: "viewport",
      ...
      crossOrigin: "anonymous"
    }), this.props.styleTags), __jsx("body", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_7__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_7__["NextScript"], null)));
  }
